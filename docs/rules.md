...
| Rule ID                                                                                                                | Description                                                   |          |
| :--------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------ | :------- |
| [svelte/@typescript-eslint/no-useless-default-assignment](./rules/@typescript-eslint/no-useless-default-assignment.md) | disallow default values that will never be used               | :wrench: |
